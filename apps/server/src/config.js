...
export function loadConfig(repoRoot) {
  ...
  const config = {
    ...
    publicSiteUrl: process.env.PUBLIC_SITE_URL || "https://getvibeshare.com",
    publicWebAppUrl: process.env.PUBLIC_WEB_APP_URL || "https://app.getvibeshare.com",
    publicApiUrl: process.env.PUBLIC_API_URL || "https://api.getvibeshare.com",
